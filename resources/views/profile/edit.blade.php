<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg" id="update-password-section">
                <div class="max-w-xl">
                        ...
                        <form method="post" action="{{ route('password.update') }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    type="password" 
                                    class="block w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm px-3 py-2" 
    ...
    @push('scripts')
    <script>
        // Scroll to update-password section if hash is present
        if (window.location.hash === '#update-password') {
            setTimeout(function() {
                const element = document.getElementById('update-password-section');
                if (element) {
