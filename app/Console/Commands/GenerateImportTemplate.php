...
class GenerateImportTemplate extends Command
{
    ...
    protected $description = 'Generate ImportUserTemplate.xlsx for user imports';

    public function handle()
    {
        $this->info('Generating ImportUserTemplate.xlsx...');
        ...
        try {
            ...
            $filePath = $templateDir . '/ImportUserTemplate.xlsx';
